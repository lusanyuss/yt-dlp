...
def separate_audio(input, output, output_format='FLAC', Separation_mode='Vocals/Instrumental', input_gain=0, restore_gain_after_separation=False,
                   filter_vocals_below_50hz=False, BigShifts=3, BSRoformer_model='ep_317_1297', weight_BSRoformer=10, weight_InstVoc=4, use_VitLarge=True,
                   weight_VitLarge=1, use_InstHQ4=False, weight_InstHQ4=2, overlap_InstHQ4=0.1, use_VOCFT=False, weight_VOCFT=2, overlap_VOCFT=0.1,
                   overlap_demucs=0.6):
