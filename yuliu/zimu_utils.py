...
from yuliu.utils import get_mp4_duration, add_final_suffix, has_final_suffix, get_relative_path, print_yellow, print_red, delete_file, CommandExecutor
...
# def add_final_shuiyin_to_video(video_nobgm, srt_path=None, codec='h264_nvenc', crf=23, preset='medium'):
...
#     # 设置黄色的PrimaryColour值为&H0000FFFF
